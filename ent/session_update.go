...
func (su *SessionUpdate) SetBalance(i int64) *SessionUpdate {
	su.mutation.ResetBalance()
	su.mutation.SetBalance(i)
	return su
}

// AddBalance adds i to balance.
func (su *SessionUpdate) AddBalance(i int64) *SessionUpdate {
	su.mutation.AddBalance(i)
	return su
}

// SetGame sets the game field.
func (su *SessionUpdate) SetGame(s string) *SessionUpdate {
	su.mutation.SetGame(s)
	return su
}

// SetNillableGame sets the game field if the given value is not nil.
func (su *SessionUpdate) SetNillableGame(s *string) *SessionUpdate {
	if s != nil {
		su.SetGame(*s)
	}
	return su
...
func (su *SessionUpdate) ClearGame() *SessionUpdate {
...
func (su *SessionUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := su.mutation.Game(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
...
// SetBalance sets the balance field.
func (suo *SessionUpdateOne) SetBalance(i int64) *SessionUpdateOne {
	suo.mutation.ResetBalance()
	suo.mutation.SetBalance(i)
	return suo
}

// AddBalance adds i to balance.
func (suo *SessionUpdateOne) AddBalance(i int64) *SessionUpdateOne {
	suo.mutation.AddBalance(i)
	return suo
}

// SetGame sets the game field.
func (suo *SessionUpdateOne) SetGame(s string) *SessionUpdateOne {
	suo.mutation.SetGame(s)
	return suo
}

// SetNillableGame sets the game field if the given value is not nil.
func (suo *SessionUpdateOne) SetNillableGame(s *string) *SessionUpdateOne {
	if s != nil {
		suo.SetGame(*s)
	}
	return suo
...
// ClearGame clears the value of game.
func (suo *SessionUpdateOne) ClearGame() *SessionUpdateOne {
...
func (suo *SessionUpdateOne) sqlSave(ctx context.Context) (s *Session, err error) {
	...
	if value, ok := suo.mutation.Game(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: session.FieldGame,
